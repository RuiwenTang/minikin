...
#ifndef MINIKIN_INCLUDE_TXT_PARAGRAPH_H_
#define MINIKIN_INCLUDE_TXT_PARAGRAPH_H_

#include <minikin/MinikinFont.h> // MinikinRect
...
/**
 * @class Paragraph
 *  Based on Flutter::Paragraph but make it with out flutter base lib and skia
 */
class Paragraph {
public:
    enum Affinity {
    ...
    struct PositionWithAffinity {
        ...
        PositionWithAffinity(const size_t position, const Affinity affinity)
              : position(position), affinity(affinity) {}
    };
...
#endif // MINIKIN_INCLUDE_TXT_PARAGRAPH_H_
